...
pickle.dump(zeta_jj, open("{}/zetaATLAS_jj.pkl".format(basedir), "wb"))
pickle.dump(zeta_bb, open("{}/zetaATLAS_bb.pkl".format(basedir), "wb"))
pickle.dump(sigmatilde, open("{}/sigmatildeATLAS.pkl".format(basedir), "wb"))
pickle.dump(xs, open("{}/xsATLAS.pkl".format(basedir), "wb"))
