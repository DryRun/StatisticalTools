...
def main():
	...
	signal_norm5 = RooRealVar('signal_norm5','signal_norm5',0,-1e+05,1e+05)
        ...
        p6 = RooRealVar('p6','p6',args.p1,0.,100.)
        p7 = RooRealVar('p7','p7',args.p2,0.,60.)
        p3 = RooRealVar('p3','p3',args.p3,-10.,10.)
	p4 = RooRealVar('p4','p4',5.6,-50.,50.)
	p5 = RooRealVar('p5','p5',10.,-50.,50.)
	p1 = RooRealVar('p1','p1',41.,0.,80.)
	p2 = RooRealVar('p2','p2',8.,0.,60.)
	...
	p17 = RooRealVar('p17','p17',0.6,-50.,50.)
        ...
        background3 = RooGenericPdf('background3','(pow(1-@0/%.1f,@1)/pow(@0/%.1f,@2+@3*log(@0/%.1f)))'%(sqrtS,sqrtS,sqrtS),RooArgList(mjj,p6,p7,p3))
	...
	background = RooGenericPdf('background','(1/pow(1.+@1*@0/%.1f,@2))'%(sqrtS),RooArgList(mjj,p1,p2))
