...
def main():
	...
	signal_norm5 = RooRealVar('signal_norm5','signal_norm5',0,-1e+05,1e+05)
        ...
        p8 = RooRealVar('p8','p8',args.p1,0.,100.)
        p9 = RooRealVar('p9','p9',args.p2,0.,60.)
        p10 = RooRealVar('p10','p10',args.p3,-10.,10.)
	p4 = RooRealVar('p4','p4',5.6,-50.,50.)
	p5 = RooRealVar('p5','p5',10.,-50.,50.)
	p6 = RooRealVar('p6','p6',.016,-50.,50.)
	p7 = RooRealVar('p7','p7',8.,-50.,50.)
	p1 = RooRealVar('p1','p1',41.,0.,60.)
	p2 = RooRealVar('p2','p2',0.,-10.,10.)
	p3 = RooRealVar('p3','p3',8.,0.,60.)
	...
	p17 = RooRealVar('p17','p17',0.6,-50.,50.)
        ...
        background4 = RooGenericPdf('background4','(pow(1-@0/%.1f,@1)/pow(@0/%.1f,@2+@3*log(@0/%.1f)))'%(sqrtS,sqrtS,sqrtS),RooArgList(mjj,p8,p9,p10))
	...
	background = RooGenericPdf('background','(1/pow(1.+@1*@0/%.1f+@2*pow(@0/%.1f,2),@3))'%(sqrtS,sqrtS),RooArgList(mjj,p1,p2,p3))
