...
limit_signal_masses = {
	"trigbbl_CSVTM":[325, 350, 400, 450, 500, 550, 600, 650, 700, 750, 800],
	"trigbbh_CSVTM":range(600, 1250, 50),
	"trigbbll_CSVTM":[325, 350, 400, 450, 500, 550, 600, 650, 700, 750, 800],
...
limit_p2sigma_estimates = {
	...
	"trigbbl_CSVTM":{
		"Hbb":{800.0:0.044405, 750.0:0.04907, 700.0:0.055848, 650.0:0.065613, 600.0:0.081398, 550.0:0.114254, 500.0:0.135334, 450.0:(0.135334+0.627745)/2., 400.0:0.627745, 375:0.45, 350:0.6, 325:0.8},
		"RSG":{800.0:0.044812, 750.0:0.049796, 700.0:0.056204, 650.0:0.065271, 600.0:0.079637, 550.0:0.117042, 500.0:0.14398, 450.0:(0.14398+0.598384)/2., 400.0:0.598384, 375:0.45, 350:0.6, 325:0.8}
	}
}
limit_m2sigma_estimates = {
	...
	"trigbbl_CSVTM":{
		"Hbb":{325:0.1, 350:0.09, 400.0:0.175381, 450.0:(0.175381+0.015603)/2., 500.0:0.015603, 550.0:0.01208, 600.0:0.010857, 650.0:0.010387, 700.0:0.010275, 750.0:0.010221, 800.0:0.01033},
		"RSG":{325:0.1, 350:0.09, 400.0:0.166479, 450.0:(0.166479+0.016075)/2., 500.0:0.016075, 550.0:0.012205, 600.0:0.010532, 650.0:0.010202, 700.0:0.010257, 750.0:0.010426, 800.0:0.010378}
	}
}
